...
export const createPayment = async ({
  ...
  try {
    ...
    const payload = {
      ...
      success_url: successUrl || `${process.env.FRONTEND_URL || 'https://portal.fxbrokersuite.com'}/user/deposits/cregis-usdt-trc20`,
      cancel_url: cancelUrl || `${process.env.FRONTEND_URL || 'https://portal.fxbrokersuite.com'}/user/deposits`,
